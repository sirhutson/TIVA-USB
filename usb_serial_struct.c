...
void deviceinfoinit()
{
DeviceInfo.ui16VID = USB_VID_TI_1CBE;
DeviceInfo.ui16PID =  USB_PID_SERIAL;
DeviceInfo.ui16MaxPowermA = 0;
DeviceInfo.ui8PwrAttributes = USB_CONF_ATTR_SELF_PWR;
DeviceInfo.pfnControlCallback = ControlHandler;
DeviceInfo.pvControlCBData = (void *)&DeviceInfo;
DeviceInfo.pfnRxCallback = USBBufferEventCallback;
DeviceInfo.pvRxCBData = (void *)&g_sRxBuffer;
DeviceInfo.pfnTxCallback = USBBufferEventCallback;
DeviceInfo.pvTxCBData = (void *)&g_sTxBuffer;
DeviceInfo.ppui8StringDescriptors = g_ppui8StringDescriptors;
